  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <img
          src="https://tribunet-frontend-prod.s3.us-east-1.amazonaws.com/assets/players_management_img.jpg"
          alt=""
      ...
      >
        ...
        >
          <div className="flex items-center gap-4">
            <Link
              to="/admin"
              className="p-2 rounded-lg bg-dark-800 border border-dark-600 text-dark-400 hover:text-white transition-colors"
            >
              <ArrowRight size={16} />
            </Link>
            <div>
